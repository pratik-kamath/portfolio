...
export function imageMapping(name, type) {
  switch (name) {
    ...
    case 'Databricks AI Agent':
      return databricksAIAgent;
...
export function handleDoubleClickiframe(name, setOpenProjectExpand, setProjectUrl, setProjectDescription) {
  ...
  switch (name) {
    ...
    case 'AiAgent':
      setProjectUrl('https://pratik-kamath.github.io/AI_chatbot/');
      break;

    case '3dObject':
      setProjectUrl('https://pratik-kamath.github.io/3d_book/');
      break;

    case 'Fortune':
      setProjectUrl('https://pratik-kamath.github.io/week_fortune/');
      break;
...
export function handleDoubleClickEnterLink(name, handleshow) {
  ...
  switch (name) {
    ...
    case 'Type': window.open('https://pratik-kamath.github.io/typingGame/', '_blank'); break;
    case '3dObject': window.open('https://pratik-kamath.github.io/3d_book/', '_blank'); break;
    case 'Fortune': window.open('https://pratik-kamath.github.io/week_fortune/', '_blank'); break;
    case 'Github':
      handleshow('Github');
      break;
    case 'LinkedIn': window.open('https://www.linkedin.com/in/pratik-kamath/', '_blank'); break;
...
export function handleDoubleTapEnterMobile(name, lastTapTime, setLastTapTime, setOpenProjectExpand, setProjectUrl) {
  ...
  if (now - lastTapTime < 300) {
    switch (name) {
      ...
      case 'Note': window.open('https://fullstack-stickynotes.netlify.app/', '_blank'); break;
      case 'Type': window.open('https://pratik-kamath.github.io/typingGame/', '_blank'); break;
      case 'Github': window.open('https://github.com/pratik-kamath/', '_blank'); break;
      case '3dObject': window.open('https://pratik-kamath.github.io/3d_book/', '_blank'); break;
      case 'Fortune': window.open('https://pratik-kamath.github.io/week_fortune/', '_blank'); break;
      default: break;
    }
