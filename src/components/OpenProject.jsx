            ...
            {openProjectExpand.show && (
              projectDescription ? (
                <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
                  <div>
                    <h2 style={{ marginBottom: '10px' }}>{projectname()}</h2>
                    <p style={{ fontSize: '14px' }}>{projectDescription}</p>
                  </div>
                  <div style={{ padding: '10px', background: '#ccc', border: '2px solid white', borderRight: '2px solid black', borderBottom: '2px solid black', textAlign: 'center', cursor: 'pointer' }}
